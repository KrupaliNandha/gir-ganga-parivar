          ...
          <div className="flex flex-col md:flex-row gap-10 mb-14">
            ...
            <div className="md:w-1/2 border-l-4 border-emerald-600 pl-6">
              <p className="text-gray-600 text-base md:text-lg leading-relaxed">
                ...
                former Home Minister Shri Gordhanbhai Zadaphia, who also serves
                as the President of the GEB Engineers’ Association. This
                reservoir, a retirement gift in honor of Shri B.M. Shah Saheb,
                Secretary General of the GEB Engineers’ Association,
          ...
          <div className="flex flex-col md:flex-row gap-10 mb-14">
            ...
            <div className="md:w-1/2 border-l-4 border-emerald-600 pl-6">
              <p className="text-gray-600 text-base md:text-lg leading-relaxed">
                ...
                owners. The “Nava Neer Na Vadhamna” (Welcoming New Waters) event
                was attended by MLA Bharatbhai Sutariya and Deputy Chief Whip
                Kaushikbhai Vekariya, highlighting the importance of this
