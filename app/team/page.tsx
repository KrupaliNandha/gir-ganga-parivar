    ...
    <section className="container">
      <div className="max-w-7xl mx-auto space-y-10">
        <div className="text-center">
          <span className="text-teal-600 text-4xl font-bold uppercase tracking-widest">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-start">
          ...
          <div className="lg:col-span-2 space-y-6 items-center">
            <div>
              <div className="w-12 h-1 bg-gradient-to-r from-teal-500 to-cyan-400 rounded-full mt-4 justify-self-center lg:justify-self-start"></div>
            </div>
              ...
              {sent ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-slate-500 mb-6">
                    Thank you for applying as a volunteer. Our team will contact
                    you soon.
                  </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-gradient-to-r from-teal-600 to-cyan-500 text-white font-bold py-3.5 rounded-xl shadow-lg"
                  >
