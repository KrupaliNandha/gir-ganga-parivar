...
const involvement = [
  {
    ...
    btn: "Donate Now", href: "/donation",
  },
  {
    num: "02", title: "Volunteer",
    ...
    btn: "Join Us", href: "/team",
  },
  {
    num: "03", title: "Partnership",
    ...
    btn: "Partner With Us", href: "/partner-with-us-csr",
  },
];
    ...
    <div className="bg-white text-gray-800">
      ...
      <section className="containers py-20 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
          ...
          <motion.h1 variants={fadeUp} transition={{ duration: 0.6 }}
            ...
            Conserving <span className="text-[var(--color-primary)]">Water,</span>
            <br />Reviving Gujarat's Future
          </motion.h1>
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.03, boxShadow: "0 12px 32px rgba(0,0,0,0.10)" }}
          ...
          >
            ...
            <div>
              ...
              <span className="text-xs text-[var(--color-primary)] font-semibold">"Waterman of India" 💧</span>
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          {/* Tall image */}
          <motion.div
            variants={slideRight} transition={{ duration: 0.7, ease: "easeOut" }}
            whileHover="imgHover" initial="imgRest" animate="imgRest"
            className="row-span-2 rounded-3xl overflow-hidden relative cursor-pointer"
          >
            <motion.div
              variants={{ imgRest: { scale: 1 }, imgHover: { scale: 1.07, transition: { duration: 0.5, ease: "easeOut" } } }}
              className="w-full h-full"
            >
              <Image src="/image/home/Slide1.png" alt="Water conservation work"
                width={500} height={600} className="object-cover w-full h-full" />
            </motion.div>
            <motion.div
              variants={{ imgRest: { opacity: 0 }, imgHover: { opacity: 1, transition: { duration: 0.3 } } }}
          ...
          {/* Top-right image */}
          <motion.div
            variants={slideRight} transition={{ duration: 0.7, delay: 0.15, ease: "easeOut" }}
            whileHover="imgHover" initial="imgRest" animate="imgRest"
            className="rounded-3xl overflow-hidden relative cursor-pointer"
          >
            <motion.div
              variants={{ imgRest: { scale: 1 }, imgHover: { scale: 1.09, transition: { duration: 0.5, ease: "easeOut" } } }}
              className="w-full h-full"
            >
              <Image src="/image/home/Slide2.png" alt="Check dam"
                width={400} height={200} className="object-cover w-full h-full" />
            </motion.div>
            <motion.div
              variants={{ imgRest: { opacity: 0 }, imgHover: { opacity: 1, transition: { duration: 0.3 } } }}
          ...
          {/* Bottom-right image */}
          <motion.div
            variants={slideRight} transition={{ duration: 0.7, delay: 0.3, ease: "easeOut" }}
            whileHover="imgHover" initial="imgRest" animate="imgRest"
            className="rounded-3xl overflow-hidden relative cursor-pointer"
          >
            <motion.div
              ...
              className="w-full h-full"
            >
              <Image src="/image/home/Slide3.png" alt="Farmers"
                width={400} height={200} className="object-cover w-full h-full" />
            </motion.div>
            <motion.div
              variants={{ imgRest: { opacity: 0 }, imgHover: { opacity: 1, transition: { duration: 0.3 } } }}
      ...
      <section className="bg-[var(--color-tertiary)] py-20">
        ...
        >
          ...
          <motion.div
            ...
            whileHover={{ y: -10, boxShadow: "0 20px 40px rgba(0,0,0,0.12)", transition: { type: "spring", stiffness: 260 } }}
            className="bg-white rounded-2xl p-8 border border-transparent hover:border-[var(--color-primary)]/20 cursor-default"
          >
            <motion.div
              whileHover={{ rotate: 15, scale: 1.2, transition: { type: "spring", stiffness: 300 } }}
            ...
            <p className="text-gray-500 text-sm leading-relaxed mt-3">
              ...
              <span className="text-[var(--color-primary)] font-semibold">people-centric movement.</span>
            </p>
          </motion.div>
          ...
          >
            <motion.div
              whileHover={{ rotate: -12, scale: 1.2, transition: { type: "spring", stiffness: 300 } }}
              className="w-10 h-10 rounded-xl bg-[var(--color-tertiary)] flex items-center justify-center mb-5 w-fit"
            >
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              ...
              known as the <span className="font-semibold text-gray-700">"Waterman of Gujarat"</span> —
              GGPT has evolved into one of India's largest grassroots water conservation movements.
            </p>
          </motion.div>
          ...
          <motion.div
            variants={staggerItem}
            whileHover={{ y: -10, scale: 1.02, boxShadow: "0 28px 56px rgba(0,0,0,0.20)", transition: { type: "spring", stiffness: 260 } }}
            className="bg-[var(--color-primary)] rounded-2xl p-8 flex flex-col justify-between cursor-default"
          >
            <motion.div
              whileHover={{ rotate: 12, scale: 1.18, transition: { type: "spring", stiffness: 300 } }}
              className="w-fit"
            >
            ...
            <p className="text-white/60 text-sm mt-6 font-medium">— Shri Dilip Sakhiya</p>
          </motion.div>
        </motion.div>
      </section>
      ...
      <section className="containers py-20">
        <motion.div
          ...
          variants={staggerContainer}
        >
          <motion.div variants={slideLeft} transition={{ duration: 0.6, ease: "easeOut" }}>
            <p className="text-xs uppercase tracking-[0.25em] text-[var(--color-primary)] mb-3">Transparency</p>
          ...
          <motion.div className="space-y-3" variants={staggerContainer}>
            {compliance.map((item, i) => (
              ...
              >
                <motion.div
                  whileHover={{ scale: 1.35, rotate: 360, transition: { duration: 0.45 } }}
                >
      ...
      {/* ══════════════════════════════
          4. IMPACT STATS
      ══════════════════════════════ */}
      <section ref={statsRef} className="relative bg-[var(--color-tertiary)] py-24 overflow-hidden">
        ...
        <div className="containers relative">
          ...
          >
            <p className="text-xs tracking-[0.25em] uppercase text-[var(--color-primary)] mb-3">Our Impact</p>
            <h2 className="text-4xl font-bold">Changing Lives Through Water</h2>
            <p className="text-gray-500 text-sm mt-3 max-w-lg mx-auto">Measurable transformation across Gujarat, India</p>
          </motion.div>
          ...
          >
            {stats.map((stat, i) => (
              <motion.div
                key={i}
                variants={staggerItem}
                whileHover="cardHover" initial="cardRest" animate="cardRest"
              >
                <motion.div
                  variants={{
                    cardRest: { y: 0, scale: 1, boxShadow: "0 2px 8px rgba(0,0,0,0.06)" },
                    cardHover: {
                      y: -12, scale: 1.03,
                ...
                >
                  <motion.div
                    variants={{
                      cardRest: { backgroundColor: "var(--color-tertiary)", rotate: 0 },
                      cardHover: { backgroundColor: "var(--color-primary)", rotate: 8, transition: { duration: 0.3 } },
                    }}
      ...
      <section className="containers py-28">
        ...
        >
          {/* Story image */}
          <motion.div
            variants={slideLeft} transition={{ duration: 0.7, ease: "easeOut" }}
            whileHover="imgHover" initial="imgRest" animate="imgRest"
            className="relative rounded-3xl overflow-hidden h-[440px] cursor-pointer"
          >
            <motion.div
              variants={{ imgRest: { scale: 1 }, imgHover: { scale: 1.06, transition: { duration: 0.6, ease: "easeOut" } } }}
              className="w-full h-full"
            >
              <Image src="/image/home/Slide4.png" alt="Water conservation story"
                width={900} height={600} className="object-cover w-full h-full" />
            </motion.div>

            <motion.div
              variants={{ imgRest: { opacity: 1 }, imgHover: { opacity: 0.8, transition: { duration: 0.4 } } }}
              className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent"
            />

            {/* Text slides up on hover */}
            <motion.div
              variants={{ imgRest: { y: 0 }, imgHover: { y: -8, transition: { duration: 0.4, ease: "easeOut" } } }}
              className="absolute bottom-8 left-8 text-white max-w-sm"
            >
              <p className="text-xs tracking-[0.2em] uppercase text-[var(--color-secondary)] mb-2">Our Story</p>
              <h3 className="text-2xl font-semibold leading-snug mb-2">Reviving Water Scarce Villages</h3>
          ...
          <motion.div className="space-y-8" variants={staggerContainer}>
            <motion.div variants={staggerItem}>
              <p className="text-xs uppercase tracking-[0.25em] text-[var(--color-primary)] mb-4">How We Work</p>
              <h2 className="text-4xl font-bold leading-tight">A Movement Built<br />on Three Pillars</h2>
            </motion.div>
            ...
            {[
              ...
              >
                <motion.div
                  whileHover={{ scale: 1.18, rotate: 10, boxShadow: "0 4px 16px rgba(0,0,0,0.18)", transition: { type: "spring", stiffness: 300 } }}
      ...
      <section className="bg-[var(--color-tertiary)] py-0 overflow-hidden">
        ...
        >
          ...
          >
            <motion.div
              variants={{ imgRest: { scale: 1 }, imgHover: { scale: 1.07, transition: { duration: 0.6, ease: "easeOut" } } }}
              className="absolute inset-0"
            >
              <Image src="/image/home/Slide1.png" alt="Your contribution matters" fill className="object-cover" />
            </motion.div>
            <motion.div
              variants={{ imgRest: { opacity: 1 }, imgHover: { opacity: 0.6, transition: { duration: 0.4 } } }}
          ...
          >
            <p className="text-white/60 text-xs uppercase tracking-[0.25em] mb-4">Make a Difference</p>
            ...
            <motion.a
              whileHover={{ scale: 1.06, boxShadow: "0 8px 24px rgba(0,0,0,0.22)" }}
              whileTap={{ scale: 0.97 }}
              href="/donation"
      ...
      <section className="containers py-24">
        <motion.div
          ...
          variants={fadeUp} transition={{ duration: 0.6 }}
        >
          <p className="text-xs uppercase tracking-[0.25em] text-[var(--color-primary)] mb-3">Testimonials</p>
        ...
        >
          {stories.map((s, i) => (
            <motion.div
              ...
              whileHover={{
                y: -12, scale: 1.02,
                boxShadow: i === 0 ? "0 28px 56px rgba(0,0,0,0.22)" : "0 20px 44px rgba(0,0,0,0.12)",
                transition: { type: "spring", stiffness: 260, damping: 18 },
              }}
            ...
            >
              <motion.div
                whileHover={{ y: -4, rotate: -10, transition: { type: "spring", stiffness: 300 } }}
                className="w-fit"
              >
                <Quote size={28} className={i === 0 ? "text-white/25" : "text-[var(--color-primary)]/20"} />
              </motion.div>

              <p className={`text-sm leading-relaxed flex-1 ${i === 0 ? "text-white/85" : "text-gray-500"}`}>
                {s.quote}
              </p>

              <div className="flex items-center gap-3 pt-4 border-t border-white/10">
                <motion.div
                  whileHover={{ scale: 1.18, rotate: 6, transition: { type: "spring", stiffness: 300 } }}
                ...
                <div>
                  <p className={`font-semibold text-sm ${i === 0 ? "text-white" : "text-gray-800"}`}>{s.name}</p>
                  <p className={`text-xs mt-0.5 ${i === 0 ? "text-white/50" : "text-gray-400"}`}>{s.role}</p>
                </div>
              </div>
            </motion.div>
          ))}
      ...
      <section className="bg-[var(--color-tertiary)] py-24">
        <div className="containers">
          <motion.div
            ...
            variants={fadeUp} transition={{ duration: 0.6 }}
          >
            <p className="text-xs uppercase tracking-[0.25em] text-[var(--color-primary)] mb-3">Get Involved</p>
          ...
          >
            {involvement.map((card) => (
              ...
              >
                <motion.div
                  variants={{
                    cardRest: { y: 0, boxShadow: "0 2px 8px rgba(0,0,0,0.05)", borderColor: "rgb(243 244 246)" },
                    cardHover: {
                      y: -12, boxShadow: "0 28px 56px rgba(0,0,0,0.13)", borderColor: "var(--color-primary)",
                      transition: { type: "spring", stiffness: 260, damping: 18 },
                    },
                  }}
                ...
                >
                  <motion.p
                    variants={{
                      ...
                      cardHover: { color: "var(--color-primary)", transition: { duration: 0.25 } },
                    }}
                  ...
                  <ul className="space-y-2 mb-8 flex-1">
                    {card.items.map((item) => (
                      <motion.li
                        ...
                        variants={{
                          cardRest: { x: 0 },
                          cardHover: { x: 5, transition: { type: "spring", stiffness: 300 } },
                        }}
                  ...
                  <motion.a
                    whileHover={{ scale: 1.06, boxShadow: "0 6px 20px rgba(0,0,0,0.18)" }}
                    whileTap={{ scale: 0.97 }}
                    href={card.href}
      ...
      <motion.section
        ...
        variants={fadeUp} transition={{ duration: 0.6 }}
      >
        <p className="text-xs uppercase tracking-[0.25em] text-white/60 mb-4">Join the Movement</p>
        <h2 className="text-3xl font-bold mb-4">Support the Water Conservation Movement</h2>
        <p className="text-white/70 text-sm mb-8 max-w-md mx-auto">
          Together we can restore water security for millions of families across drought-prone Saurashtra.
        </p>
        <motion.a
          whileHover={{ scale: 1.07, boxShadow: "0 10px 28px rgba(0,0,0,0.25)" }}
          whileTap={{ scale: 0.96 }}
          href="/donation"
